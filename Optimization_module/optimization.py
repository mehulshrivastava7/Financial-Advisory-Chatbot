...
# Download data
    ...
    # Run optimization
    optimal_weights, optimal_sharpe= stochastic_sharpe_optimization(market_cap,data, risk_free_rate)

    
    return optimal_weights, optimal_sharpe,tickers
...
if __name__ == "__main__":
    try:
        ...
        optimal_weights, optimal_sharpe,tickers = stochastic_optimization(tickers)
