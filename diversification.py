...
def preprocess_data(input_csv='sample_indian_stocks_data.csv'):
    """
    Preprocess the stock data: handle missing values, encode categorical variables, and scale features.
    ...
    # print("\nEncoding categorical variables (Sector) using get_dummies...")
...
def main(sample_user_portfolio):
    ...
    input_csv = '/home/arnavbhatt/mehul/sample_indian_stocks_data.csv'
